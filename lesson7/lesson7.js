...
var STONE_SPEED = 10000; //Интервал появление препятствий
var snake = []; // Сама змейка
var direction = 'y+'; // Направление движения змейки
var gameIsRunning = false; // Запущена ли игра
var snake_timer; // Таймер змейки
var food_timer; // Таймер для еды
var stone_timer; // Таймер для препятствий
...
function init() {
    ...
    */
    ...
    scores.innerHTML = "Всего очков: " + score;
...
function startGame() {
    ...
    stone_timer = setInterval(createStone, STONE_SPEED);
...
function move() {
    ...
    if (direction == 'x-' && new_unit == undefined) {
    ...
    if (!isSnakeUnit(new_unit) && new_unit !== undefined) { //выход за границу поля
...
function createStone() {
    ...
    while (!stoneCreated) { //пока препятствие не создали
        // рандом
